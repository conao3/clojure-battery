...
(t/deftest test-wrap-hyphenated
...
(t/deftest test-wrap-hyphenated-numbers
  (let [text "Python 1.0.0 was released on 1994-01-26.  Python 1.0.1 was\nreleased on 1994-02-15."]
    ...
    (check-wrap text 1 ["Python" "1.0.0" "was" "released" "on" "1994-01-26." "Python" "1.0.1" "was" "released" "on" "1994-02-15."] {:break-long-words false}))
  (let [text "I do all my shopping at 7-11."]
    ...
    (check-wrap text 1 ["I" "do" "all" "my" "shopping" "at" "7-11."] {:break-long-words false})))

(t/deftest test-wrap-em-dash
  ...
  (let [text "You can also do--this or even---this."]
...
(t/deftest test-wrap-unix-options
  (let [text "You should use the -n option, or --dry-run in its long form."]
    ...
    (let [expect ["You should use the -n option, or" "--dry-run in its long form."]]
      ...
      (check-split {:width 45} "the -n option, or --dry-run or --dryrun"
                  ["the" " " "-n" " " "option," " " "or" " " "--dry-" "run"
                   " " "or" " " "--dryrun"]))
    ))

(t/deftest test-wrap-funky-hyphens
...
(t/deftest test-wrap-punct-hyphens
  (let [wrapper {:width 45}]
...
(t/deftest test-wrap-funky-parens
  (let [wrapper {:width 45}]
...
(t/deftest test-wrap-non-breaking-space
...
(t/deftest test-wrap-narrow-non-breaking-space
  (check-wrap (str "This is a sentence with non-breaking" "\u202f" "space.") 20
             ["This is a sentence" "with non-" "breaking\u202fspace."] {:break-on-hyphens true})
  (check-wrap (str "This is a sentence with non-breaking" "\u202f" "space.") 20
             ["This is a sentence" "with" "non-breaking\u202fspace."] {:break-on-hyphens false}))
...
(t/deftest test-long-word-nobreak-long
  (let [text "Did you say \"supercalifragilisticexpialidocious?\"\nHow *do* you spell that odd word, anyways?\n"
        wrapper {:width 30 :break-long-words false}
    ...
    (check expect (textwrap/wrap text 30 :break-long-words false))))

(t/deftest test-long-word-max-lines-long
  (let [text "Did you say \"supercalifragilisticexpialidocious?\"\nHow *do* you spell that odd word, anyways?\n"]
    (check-wrap text 12 ["Did you say" "\"supercalifr" "agilisticexp" "[...]"] {:max-lines 4})))

;; LongWordWithHyphensTestCase

(t/deftest test-long-word-with-hyphens-on-hyphen
  (let [text1 (str "We used enyzme 2-succinyl-6-hydroxy-2,4-cyclohexadiene-1-carboxylate synthase.\n")
    ...
    (check-wrap text1 50 ["We used enyzme 2-succinyl-6-hydroxy-2,4-cyclohexad" "iene-1-carboxylate synthase."])
    (check-wrap text1 10 ["We used" "enyzme 2-s" "uccinyl-6-" "hydroxy-2," "4-cyclohex" "adiene-1-c" "arboxylate" "synthase."])
    (check-wrap text2 10 ["1234567890" "-123456789" "0--this_is" "_a_very_lo" "ng_option_" "indeed-" "good-bye\""])))

(t/deftest test-long-word-with-hyphens-not-on-hyphen
  (let [text1 (str "We used enyzme 2-succinyl-6-hydroxy-2,4-cyclohexadiene-1-carboxylate synthase.\n")
        text2 "1234567890-1234567890--this_is_a_very_long_option_indeed-good-bye\"\n"]
    ...
    (check-wrap text2 10 ["1234567890" "-123456789" "0--this_is" "_a_very_lo" "ng_option_" "indeed-goo" "d-bye\""] {:break-on-hyphens false})))

(t/deftest test-long-word-with-hyphen-not-on-long-words
  (let [text1 (str "We used enyzme 2-succinyl-6-hydroxy-2,4-cyclohexadiene-1-carboxylate synthase.\n")
        text2 "1234567890-1234567890--this_is_a_very_long_option_indeed-good-bye\"\n"]
    ...
    (check-wrap text2 10 ["1234567890-1234567890" "--" "this_is_a_very_long_option_indeed-" "good-bye\""] {:break-long-words false})))

(t/deftest test-long-word-with-no-break-long-words-or-hyphens
  (let [text1 (str "We used enyzme 2-succinyl-6-hydroxy-2,4-cyclohexadiene-1-carboxylate synthase.\n")
        text2 "1234567890-1234567890--this_is_a_very_long_option_indeed-good-bye\"\n"]
    ...
    (check-wrap text2 10 ["1234567890-1234567890--this_is_a_very_long_option_indeed-good-bye\""] {:break-long-words false :break-on-hyphens false})))

;; IndentTestCases

(t/deftest test-indent-cases-fill
...
(t/deftest test-indent-cases-initial-indent
  (let [text "This paragraph will be filled, first\nwithout any indentation, and then with\nsome (including a hanging indent)."
...
(t/deftest test-indent-cases-subsequent-indent
  (let [text "This paragraph will be filled, first\nwithout any indentation, and then with\nsome (including a hanging indent)."
...
(t/deftest test-dedent-whitespace
  (let [text ""]
...
(t/deftest test-dedent-preserve-margin-tabs
...
(t/deftest test-indent-empty-lines
  (let [prefix "  "
        expected ["  Hi.\n  This is a test.\n  Testing."
                  "  Hi.\n  This is a test.\n\n  Testing."
                  "\n  Hi.\n  This is a test.\n  Testing.\n"
...
(t/deftest test-shorten-placeholder
  (let [text "Hello there, how are you this fine day? I'm glad to hear it!"]
...
(t/deftest test-shorten-empty-string
  (check-shorten "" 6 ""))

(t/deftest test-shorten-whitespace
...
(t/deftest test-shorten-width-too-small-for-placeholder
...
(t/deftest test-shorten-first-word-too-long-but-placeholder-fits
